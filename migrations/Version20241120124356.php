 ...
 */
final class Version20241120124356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, adr_type VARCHAR(50) NOT NULL, adr_city VARCHAR(50) NOT NULL, adr_address VARCHAR(255) NOT NULL, adr_cp INT NOT NULL, is_default TINYINT(1) NOT NULL, INDEX IDX_D4E6F81A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE supplier_details (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, spl_type VARCHAR(50) NOT NULL, spl_status TINYINT(1) NOT NULL, INDEX IDX_F3437F95A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, user_ref VARCHAR(50) NOT NULL, user_firstname VARCHAR(100) NOT NULL, user_lastname VARCHAR(100) NOT NULL, user_phone VARCHAR(20) NOT NULL, coef NUMERIC(5, 2) NOT NULL, user_siret VARCHAR(20) DEFAULT NULL, user_last_conn DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_verified TINYINT(1) NOT NULL, INDEX IDX_8D93D649ED5CA9E6 (service_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_USER_REF (user_ref), UNIQUE INDEX UNIQ_USER_SIRET (user_siret), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
